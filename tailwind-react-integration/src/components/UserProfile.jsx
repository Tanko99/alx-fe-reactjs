...
function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 sm:p-4 md:p-8 md:max-w-sm mx-auto my-20 
    max-w-xs rounded-lg shadow-lg">
      ...
      <h1 className=" sm:text-lg md:text-xl text-blue-800 sm:my-2 my-4">John Doe</h1>
