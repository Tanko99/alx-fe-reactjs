  ...
  return (
    <div className="min-h-screen bg-green-400 sm:px-8 px-4 py-6">
      <div className="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        {/* Ingredients */}
        <div className="mb-6">
          <h2 className="md:text-2xl sm:text-lg text-xl font-semibold mb-2">Ingredients</h2>
        ...
        {/* Instructions */}
        <div>
          <h2 className="md:text-2xl sm:::text-lg text-xl font-semibold mb-2">Instructions</h2>
